...
export default function Login() {
    ...
    const authParams ={
        ...
        accessType: "offline",
        redirectUri: "http://calendar-adjustment.mydns.jp/auth_code",
    ...
    const sequelize = new Sequelize('http://adjust-database.cfrxbhoksmto.us-east-1.rds.amazonaws.com/', 'admin', 'smnkisno1', {
