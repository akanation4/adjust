...
function Authorized({unauthorized, children}) {    const data = require("./client_secret2.json");
    const dataObject = JSON.parse(data);

    authParams.clientId = dataObject.client_id;
    authParams.clientSecret = dataObject.client_secret;
