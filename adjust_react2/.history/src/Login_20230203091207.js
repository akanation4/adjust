...
export default function Login() {
    ...
    const authParams ={
        clientId: "???",
        clientSecret: "???",
        scope: "https://www.googleapis.com/auth/calendar" "profileemail",
        responseType: "code",
    ...
    async function sendAPI() {
        const authInfo = getAuthInfo();
        const header = {'Access-Control-Allow-Origin': 'http://akanation4.server-on.net:8080/test',
                        'Content-Type' : 'application/json'};

        const test = await axios.post('http://akanation4.server-on.net:8080/test', authInfo, {headers: header});
